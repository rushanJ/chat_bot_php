...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <form class="w3-container" action="php/newItemSpec.php" method="POST">
  

  <label class="w3-text-teal"><b> Name</b></label>
  <select class="w3-select w3-border" name="spec">
 ...
 <label class="w3-text-teal"><b> Discription</b></label>
  ...
  <input class="w3-input w3-border w3-light-grey"name="itemId"  value ='<?php echo $_REQUEST["id"]?>'  type="hidden">

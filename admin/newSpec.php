...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar">
      <span>Welcome, <strong>ANDMIN</strong></span><br>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <form class="w3-container" action="php/newItem.php" method="POST">
 ...
 <br>
  ...
  <form class="w3-container" action="api/newItemSpec.php" method="POST">
  
  <label class="w3-text-teal"><b> Name</b></label>
  <input class="w3-input w3-border w3-light-grey"name="name" type="text">

  <label class="w3-text-teal"><b> Discription</b></label>
  <input class="w3-input w3-border w3-light-grey"name="discription" type="text">
<br>
  <select class="w3-select w3-border" name="option">
  <?php include "php/getSpecs.php" ?> 
  </select>

  <input class="w3-input w3-border w3-light-grey"name="item" value ='<?php echo $_REQUEST["id"]?>' type="hidden">

 <br>
 <input class="w3-input w3-border w3-light-grey" type="submit">
  <!-- <button class="w3-btn w3-blue-grey">Add</button> -->
</form>
